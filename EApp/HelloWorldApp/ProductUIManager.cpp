...
using namespace std;
	...
	void ProductUIManager::displayWelcomeMessage() {
		std::cout << "Welcome to Transflower Store!" << std::endl;
	}
	void ProductUIManager::displayGoodbyeMessage() {
		std::cout << "Thank you for visiting Transflower Store!" << std::endl;
	}
	void ProductUIManager::displayErrorMessage(const std::string& message) {
		std::cout << "Error: " << message << std::endl;
	}
	void ProductUIManager::displaySuccessMessage(const std::string& message) {
		std::cout << "Success: " << message << std::endl;
	}


	void ProductUIManager::displayProductDetails(const Product& product) {
		product.display();
	}

	void ProductUIManager::displayProducts(const ProductRepository& repo) {
		repo.displayProducts();
	}

	void ProductUIManager::displayProductNotFound() {
		std::cout << "Product not found!" << std::endl;
	}

	void ProductUIManager::displayProductAdded() {
		std::cout << "Product added successfully!" << std::endl;
	}


	void ProductUIManager::displayMenu() {
	...
	void ProductUIManager::getProductDetails(int& id, string& title, string& description, string& category, int& quantity, double& price) {
	...
	void ProductUIManager::getDiscountDetails(int& productId, double& discount) {
		std::cout << "Enter Product ID: ";
		std::cin >> productId;
	...
	void ProductUIManager::getProductId(int& productId) {
		std::cout << "Enter Product ID: ";
		std::cin >> productId;
	}


	void ProductUIManager::getProductIndex(int& index) {
		std::cout << "Enter Product Index: ";
		std::cin >> index;
	}


	void ProductUIManager::getProductTitle(string& title) {
		std::cout << "Enter Product Title: ";
		std::cin.ignore();
		std::getline(std::cin, title);
	}

	void ProductUIManager::handleUserInput(ProductsController& controller) {
		int choice;
		do {
			displayMenu();
